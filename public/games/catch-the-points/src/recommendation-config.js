...
export const recommendationContent = {
  ...
  devaluation: { type:'negative', eyebrow:'ĐỐI THỦ LỚN NHẤT', title:'Devaluation', message:s=> `Devaluation cuốn đi ${n(s.devaluationDamage)} điểm. Đến lúc chia điểm ra nhiều giỏ rồi.`, ctaText:'Vì sao nên có nhiều loại điểm?', destination:'diversification', trackingId:'diversification_guide' },
