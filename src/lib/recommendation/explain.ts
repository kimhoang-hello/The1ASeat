...
const QUESTION_PRIORITY: Partial<Record<UserDataGap["kind"], number>> = {
  ...
  trip_cabin_unknown: 2,
  trip_passengers_unknown: 3,
  trip_round_trip_unknown: 4,
  cards_undeclared: 5,
  balances_undeclared: 6,
  minimum_spend_capacity_unknown: 7,
  spend_profile_missing: 8,
  personal_income_unknown: 9,
  household_income_unknown: 10,
  business_cards_preference_unknown: 11,
  point_balance_amount_unknown: 12,
  annual_fee_tolerance_unknown: 13,
  spend_category_unknown: 14,
  card_closed_date_unknown: 15,
  business_ownership_unknown: 16,
  student_status_unknown: 17,
  trip_dates_unknown: 18,
  trip_flexibility_unknown: 19,
};
