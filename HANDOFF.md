...
| Thẻ không có bonus (hoặc bonus bị chặn) nhận `spend_fit` = 1 KHI ĐÃ BIẾT sức dồn | Chưa biết sức dồn thì mọi thẻ cùng 0.5 từ engine 4.30.0 (audit 25/09/2026 — trước đó thẻ bị chặn bonus đứng hạng nhất nhờ đúng vế này). Đã biết sức dồn mà mốc chi quá sức thì thẻ không bonus vẫn có thể thắng thẻ có bonus — quy ước "không có mốc = phù hợp tối đa" giữ nguyên |
